...
class Reporte_Errores():
        ...
        while i < len(contenido):
            ...
            if estado == 0:
                if c == "<":
                    ...
                    self.errores.append(Error(buffer, linea, columna))
                    buffer = ""
    ...
    def html_Errores(self):
        
        
        inicio = '<!DOCTYPE HTML5> <html><head><title>Reporte de Errores</title></head><body style="background-color:#82FF77;"><h1  align="center"> Reporte de errores </h1>'
        Fin = '</body></html>'
        tabla_inicio= '<center><table border="1"><caption>Errores encontrados en el archivo con linea y columna</caption><tr style="background-color:#1DFFE6;"><th>Caracter/Expresion</th><th>Linea</th><th>Columna</th></tr>'
        tabla_fin = '</table></center>'
        
        for c in self.errores:
            tabla_inicio += '<tr style="background-color:#A7FFF5;"><td  align="center">' + str(c.descripcion) + '</td><td  align="center">' + str(c.linea) + '</td><td  align="center">' + str(c.columna) + '</td></tr>'
